...
class PipelineParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.debug = False
        self.exp_name = "no_name"
        self.depth_ratio = 0.0
        self.no_spike = False # the default is to use our spiking neuron 
        self.no_cut = False
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.lambda_tv_d = 0.
        self.lambda_round = 0.0
        self.lambda_normal = 0.04
        self.lambda_smooth = 1.0
        self.fil_width = 1
        self.depth_grad_thresh = 0.0

...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0]):
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            ...
            scene_info = sceneLoadTypeCallbacks["dtu"](args.source_path, args.white_background, args.eval)
    ...
    def save(self, iteration):
        ...
        state_dict = {
            'Vth_opa': self.gaussians.Vth_opa,
            'Vth_pdf': self.gaussians.Vth_pdf
        }
        torch.save(state_dict, os.path.join(point_cloud_path, "point_cloud.pth"))
